  ...
  return (
    <DashboardLayout>
      <div className="relative space-y-6">
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_20%_0%,rgba(56,189,248,0.12),transparent_45%),radial-gradient(circle_at_80%_10%,rgba(94,234,212,0.1),transparent_40%),radial-gradient(circle_at_50%_80%,rgba(59,130,246,0.08),transparent_45%)]" />
        <div className="surface-card px-4 py-4 rounded-2xl border border-white/5 bg-gradient-to-r from-white/6 to-transparent">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              <div className="text-xs uppercase tracking-[0.35em] text-muted-foreground">{t('dashboard')}</div>
              <h1 className="text-2xl font-bold mt-1">{t('trading_title')}</h1>
              <p className="text-sm text-muted-foreground">{t('trading_subtitle')}</p>
            </div>
            <div className="flex flex-wrap items-center gap-2">
              <div className="px-3 py-1 rounded-full border border-border/70 text-xs font-semibold bg-secondary/40">
                Session status: Live
              </div>
              {pulse && pulse.nasdaq && (
                <div className="px-3 py-1 rounded-full border border-border/70 text-xs font-semibold">
                  NASDAQ {pulse.nasdaq.price}
                  <span className={`ml-2 ${pulse.nasdaq.change_pct > 0 ? 'text-success' : 'text-destructive'}`}>
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            {[
              ...
              <div
                key={stat.label}
                className="surface-card px-4 py-3 rounded-2xl border border-white/5 bg-gradient-to-br from-white/8 via-white/5 to-transparent shadow-[0_12px_30px_-18px_rgba(8,12,22,0.9)]"
              >
        ...
        <div className="grid gap-6">
          <aside className="order-none">
            <div className="surface-card p-4 rounded-3xl border border-white/5 bg-gradient-to-br from-white/6 via-white/3 to-transparent">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2 flex-wrap text-xs pb-4 border-b border-white/5">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      <select
                        ...
                        className="h-9 rounded-full bg-secondary border border-border px-3 text-xs font-semibold flex-1"
                      >
                      ...
                      <button
                        ...
                        className="h-9 px-3 rounded-full border border-border text-xs font-semibold hover:border-primary/50"
                      >
            ...
            <div className="mt-4 space-y-4">
              {showCompanies ? (
                marketOrder.map((market) => (
                  ...
                  <div key={market} className="surface-card p-4 rounded-3xl border border-white/5 bg-gradient-to-br from-white/6 via-white/3 to-transparent">
                    ...
                    <div className="grid grid-cols-1 gap-2 max-h-[420px] overflow-y-auto pr-1">
                      {(groupedAssets[market] || []).map((asset) => (
                        <button
                          ...
                          className={`grid grid-cols-[auto_1fr_auto] sm:grid-cols-[auto_1fr_auto_auto] gap-3 items-center px-3 py-3 rounded-2xl border transition-all ${selectedSymbol === asset.symbol
                            ? 'border-primary/60 bg-primary/15 shadow-[0_10px_20px_-18px_rgba(59,130,246,0.7)]'
                            : 'border-white/5 bg-white/2 hover:border-primary/40'
                            }`}
                        >
                          <div className="w-8 h-8 rounded-full bg-secondary/70 border border-white/5 flex items-center justify-center font-bold text-sm">
          ...
          <section className="order-none">
            <div className="surface-card p-5 rounded-3xl border border-white/5 bg-gradient-to-br from-white/6 via-white/3 to-transparent">
              ...
              <div className="relative h-[560px] rounded-3xl overflow-hidden border border-white/5 bg-[radial-gradient(circle_at_0%_0%,rgba(59,130,246,0.12),transparent_45%),radial-gradient(circle_at_100%_0%,rgba(56,189,248,0.08),transparent_40%)]">
                {isFunded ? (
          ...
          <aside className="order-none">
            <div className="surface-card p-6 border border-white/5 rounded-3xl bg-gradient-to-br from-[#0b111a] via-[#0c1524] to-[#0f1b2f] shadow-[0_24px_48px_-30px_rgba(10,16,28,0.9)]">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold">{t('trading_execution')}</h2>
                <div className="text-xs text-muted-foreground">{t('trading_asset_type')}: {currentAsset?.market || '—'}</div>
              </div>
              <div className="space-y-5">
                <div className="grid grid-cols-2 gap-2 pb-4 border-b border-white/5">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 py-3 rounded-xl font-semibold transition-all ${
                      orderType === 'buy'
                        ? 'bg-gradient-to-r from-emerald-500/90 via-emerald-500 to-cyan-400 text-white shadow-[0_14px_30px_-18px_rgba(16,185,129,0.9)]'
                        : 'bg-[#101a2b] text-muted-foreground border border-white/5 hover:border-emerald-400/40'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 py-3 rounded-xl font-semibold transition-all ${
                      orderType === 'sell'
                        ? 'bg-gradient-to-r from-rose-500/90 via-rose-500 to-orange-400 text-white shadow-[0_14px_30px_-18px_rgba(244,63,94,0.9)]'
                        : 'bg-[#101a2b] text-muted-foreground border border-white/5 hover:border-rose-400/40'
                    }`}
                  >
                ...
                <div className="pb-4 border-b border-white/5">
                  ...
                  <Input
                    ...
                    className="bg-[#0f1a2b] border-[#1d2a3d] mt-1 focus-visible:ring-cyan-400/20 focus-visible:border-cyan-400/50"
                ...
                <div className="rounded-2xl border border-[#1d2a3d] bg-[#0f1a2b]/70 p-4 space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <select
                      ...
                      className="h-9 rounded-full bg-[#0f1a2b] border border-[#1d2a3d] px-3 text-xs font-semibold"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex items-center gap-2">
                      ...
                      <Input
                        ...
                        className="bg-[#0f1a2b] border-[#1d2a3d] h-9 focus-visible:ring-cyan-400/20 focus-visible:border-cyan-400/50"
                        disabled={!tpEnabled}
                      />
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs pb-4 border-b border-white/5">
                  <div className="rounded-xl border border-[#1d2a3d] bg-[#0f1a2b]/70 px-3 py-2">
                ...
                <Button
                  ...
                  className={`w-full text-white ${
                    orderType === 'buy'
                      ? 'bg-gradient-to-r from-emerald-500 via-emerald-400 to-cyan-400 hover:opacity-90'
                      : 'bg-gradient-to-r from-rose-500 via-rose-400 to-orange-400 hover:opacity-90'
                  }`}
                >
        ...
        {viewMode === 'pro' && (
          <div className="surface-card p-6 rounded-3xl border border-white/5 bg-gradient-to-br from-white/6 via-white/3 to-transparent">
        ...
        {viewMode === 'pro' && (
          <div className="surface-card px-4 py-3 overflow-hidden hidden lg:block rounded-2xl border border-white/5 bg-gradient-to-r from-white/6 to-transparent">
